...
describe '#decodePulses()', ->
  tests = [
    {
      protocol: 'projection-screen'
      pulseLengths: [196, 600, 5228]
      pulses: [
        '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101010101100110100101101001011010102',
        '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101011001011001010110010110100101102',
        '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101011001010110100110010110011010102'
      ]
      values: [
        { command: "down"},
        { command: "up" }
  ...
  tests = [
    {
      protocol: 'projection-screen'
      message: { command: "up" }
      pulses: '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101011001011001010110010110100101102'
    },
    {
      protocol: 'projection-screen'
      message: { command: "down" }
      pulses: '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101010101100110100101101001011010102'
    },
    {
      protocol: 'projection-screen'
      message: { command: "stop" }
      pulses: '110011001010110100101100101101010100110101010011001100101010110100101010101010110010101010101010101011001010110100110010110011010102'
    },
    {
      protocol: 'switch1'
